  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-center gap-1 sm:gap-1.5 max-w-full overflow-hidden">
          {code.map((digit, index) => (
            <input
              ...
              className="w-9 h-11 sm:w-10 sm:h-12 text-center text-lg sm:text-xl font-bold border-2 border-gray-300 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed bg-white shadow-sm hover:border-gray-400 flex-shrink-0"
              disabled={loading}
              autoFocus={index === 0}
            />
          ))}
